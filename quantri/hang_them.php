...
if (isset($_POST['TenDT'])){
	...
	$qt->Hang_Sua($TenDT, $idTL, $MT, $Gia, $Ngay, $urlHinh);
			...
			<div class="body">
				<form id="form_validation" method="POST">
					<div class="form-group form-float">
						<div class="form-group form-float">
							<div class="form-line">
								<input type="text" name="urlHinh" id="urlHinh" class="form-control" onclick="selectFileWithCKFinder('urlHinh')" placeholder="Địa chỉ hình" >
							</div>
						</div>
							<div class="form-line">
								<input type="text" class="form-control" name="TenDT" required maxlength="100" minlength="5"  placeholder="Tên hàng"> 
							</div>
					</div>
					<div class="form-group form-float">
						<div class="form-line">
					...
					<div class="form-group form-float">
						<div class="form-line">
							<textarea name="MT" cols="30" rows="5" class="form-control no-resize" placeholder="Mô tả" ></textarea>
						</div>
					</div>
					...
					<button class="btn btn-primary waves-effect" type="submit">THÊM HÀNG</button>
				</form>
			</div>
		</div>
	</div>
